...
def find_max_card():
    """
    Finds the card with the most money spent. Uses the fact that
...
start_t = time.time()
(max_card, max_money) = find_max_card()
print("Finding max card took {} seconds".format(time.time() - start_t))
print("The card with the most money spent was", max_card, "with", max_money, "units.")
